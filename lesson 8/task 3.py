...
def segment(p1, p2):
    """
    Функция segment принимает два кортежа с координатами точек (x1, y1), (x2, y2) и возвращает сумму всех координат.
    Если при передаче аргументов происходит ошибка, то функция отлавливает исключение Exception и возвращает текст
    исключения задом наперед (используется срез [::-1] для разворота строки).
    """
    try:
        x1, y1 = p1
        x2, y2 = p2
